<?php
 include_once 'model.php';
    ...
    class Admin extends Model{
        ...
        protected static $table_fields = array('admin_id' ,'first_name','last_name','dob','email','address','username','passport','hash','city','country','phone','aboutme');
        ...
        public static function authenticate($hash, $admin_id){
            $hash = md5($hash);
            $sql = " SELECT * FROM ".static::$table_name." WHERE admin_id  = '$admin_id ' AND hash = '$hash'  LIMIT 1";
