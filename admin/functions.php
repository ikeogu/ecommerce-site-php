...
if(isset($_GET['add_cart'])){
	...
	$run_check = mysql_query($con, $check_pro); 
	...
	$run_pro = mysql_query($con, $insert_pro); 
...
function getCatPro(){
	...
	$run_cat_pro = mysql_query($con, $get_cat_pro); 
	
	$count_cats = mysql_num_rows($run_cat_pro);
	
	if($count_cats==0){
	
	echo "<h2>No products where found in this category!</h2>";
...
function getBrandPro(){
	...
	$run_brand_pro = mysql_query($con, $get_brand_pro); 
